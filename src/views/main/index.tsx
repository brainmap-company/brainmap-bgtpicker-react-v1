...
const ImageCard: React.FC<ImageCardProps> = ({ children, onClick }) => (
    <Box
        onClick={onClick}
        style={{
...
const BgtPicker: React.FC = () => {
    const [bgtFiles, setBgtFiles] = useState<string[]>([]);
    ...
    return (
        <Box padding="20px" width="100%" maxWidth="1200px" margin="0 auto">
            ...
            <form onSubmit={handleSubmit} style={{ padding: '20px 40px 20px 20px', margin: '0 auto 0px auto', backgroundColor: '#f9f9f9', borderRadius: '8px', border: '1px solid #ddd', width: '400px' }}>
                                ...
                                <ImageCard key={index} onClick={() => {
                                    ...
                                    <img
                                        ...
                                        onError={(e: React.SyntheticEvent<HTMLImageElement>) => {
                                            ...
                                            e.currentTarget.alt = `${currentType} 파일 로드 실패`;
                                        }}
